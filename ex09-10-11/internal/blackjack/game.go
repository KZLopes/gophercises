...
func New(o GameOptions) Game {
	...
	return Game{
		...
		dealerAI:        defaultDealer{},
	}
}

func (g *Game) Play(ai PlayerAI) int {
	g.deck = nil
...
func bet(g *Game, ai PlayerAI, shuffled bool) {
...
func endRound(g *Game, ai PlayerAI) {
